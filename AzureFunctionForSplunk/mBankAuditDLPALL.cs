...
{
    public static class mBankAuditDLPALL
    {
        [FunctionName("mBankAuditDLPALL")]
        public static async Task Run(
            [EventHubTrigger("%mBankAuditDLPALL%", Connection = "hubConnection", ConsumerGroup = "%consumer-group-activity-log%")] string[] messages,
