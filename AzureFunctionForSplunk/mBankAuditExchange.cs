...
{
    public static class mBankAuditExchange
    {
        [FunctionName("mBankAuditExchange")]
        public static async Task Run(
            [EventHubTrigger("%mBankAuditExchange%", Connection = "hubConnection", ConsumerGroup = "%consumer-group-activity-log%")] string[] messages,
