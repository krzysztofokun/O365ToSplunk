...
{
    public static class mBankAuditGeneral
    {
        [FunctionName("mBankAuditGeneral")]
        public static async Task Run(
            [EventHubTrigger("%mBankAuditGeneral%", Connection = "hubConnection", ConsumerGroup = "%consumer-group-activity-log%")] string[] messages,
