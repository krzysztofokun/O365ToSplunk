...
{
    public static class mBankAuditSharepoint
    {
        [FunctionName("mBankAuditSharepoint")]
        public static async Task Run(
            [EventHubTrigger("%mBankAuditSharepoint%", Connection = "hubConnection", ConsumerGroup = "%consumer-group-activity-log%")] string[] messages,
